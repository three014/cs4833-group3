  ...
  if (stringComplete) {
    ...
    switch (cmd) {
      ...
      case 2:{
        ...
        prizm.setMotorPowers(20,20);      // please note that here we hardcode the speed of the motor, you can adjust my code and transfer the speed value you want through the serial communication
        break;
      }
      // turn right
      case 3:{
